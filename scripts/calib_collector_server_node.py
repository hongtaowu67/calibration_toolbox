...
if __name__ == "__main__":
    target = 'alvar'
    calib_points_file = "/home/raya/Dropbox/210821_panda_ps_EBME/calib_points.txt"
    # image_topic = "/camera/color/image_raw" # Realsense
    image_topic = "/camera/rgb/image_raw" # Primesense
    base_frame_name = "panda_link0"
    ee_frame_name = "panda_hand"
    camera_frame_name = "camera_rgb_optical_frame"
